...
func (app *Config) logItem(w http.ResponseWriter, l LogPayload) {
	...
	payload.Error = false
	payload.Message = "message logged"
...
func (app *Config) authenticate(w http.ResponseWriter, a AuthPayload) {
	...
	// call the service. For the url we will use the name of the service we defined in docker-compose.
	...
	// Return response from Auth service back to the user
	var payload jsonResponse
	payload.Error = false
